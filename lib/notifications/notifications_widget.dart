                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '2b5nmrwk' /* Please manage your notificatio... */,
                                                  ),
                                          ...
                                          children: [
                                            SwitchListTile.adaptive(
                                              ...
                                              subtitle: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'wpc0rrkw' /* Receive Push notifications fro... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
                                            ...
                                            SwitchListTile.adaptive(
                                              ...
                                              subtitle: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'kdponjtx' /* Receive email notifications fr... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
